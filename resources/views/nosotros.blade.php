...
<head>
	...
	<body>
		...
		<div>
			<nav class="imgNosotros" style="display: flex; align-items: center; text-align: center;">
			</nav>
		</div>
		
			<div style=" text-align: center; margin-bottom: 10px;">
                <div class="abrTitle">SAPI</div>
                <div class="srvDescr2">
                    Sapi es una empresa que busca ofrecer sus servicios a organizaciones y negocios que necesiten
                    <br> de un apoyo en el alcance y venta de sus productos o servicios, respectivamente.
                </div>
                <div class="srvTitle">Misión</div>
                <div class="srvDescr2">
                    Proporcionar un medio por el cual llegar a clientes potenciales que adquieran los productos o
                    <br> servicios que el cliente en cuestión necesita.
                </div>
                <div class="srvTitle">Visión</div>
                <div class="srvDescr2">
                    Mantener un proceso eficiente para que las organizaciones se comuniquen con la confianza
                    <br>suficiente hacia nosotros, y así brindarles un servicio con alto estándar de calidad.
                </div>
